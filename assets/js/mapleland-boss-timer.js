(function () {
  ...
  const ICONS = [
    ...
    ["warrior_pill.png", { ko: "전사의 알약", en: "Warrior Pill" }],
    ["magic_pill.png", { ko: "마법사의 알약", en: "Magic Pill" }],
    ["sniper_pill.png", { ko: "명사수의 알약", en: "Sniper Pill" }],
    ["takoyaki.png", { ko: "타코야끼", en: "Takoyaki" }],
    ["yakisoba.png", { ko: "야끼소바", en: "Yakisoba" }],
  ...
  const PRESETS = [
    { id: "holy-symbol", group: "magician", icon: "holy_symbol.png", sampleKo: "홀리심볼", titleKo: "홀리심볼", titleEn: "Holy Symbol", ms: 110000 },
    ...
    { id: "infinity", group: "magician", icon: "infinity.png", sampleKo: "인피니티", titleKo: "인피니티", titleEn: "Infinity", ms: 600000 },
    { id: "resurrection-magician", group: "magician", icon: "resurrection.png", sampleKo: "리저렉션", titleKo: "리저렉션", titleEn: "Resurrection", ms: 1800000 },
    ...
    { id: "enrage", group: "warrior", icon: "enrage.png", sampleKo: "인레이지", titleKo: "인레이지", titleEn: "Enrage", ms: 360000 },
    { id: "sanctuary", group: "warrior", icon: "sanctuary.png", sampleKo: "생츄어리", titleKo: "생츄어리", titleEn: "Sanctuary", ms: 70000 },
    { id: "silver-hawk", group: "bowman", icon: "silver_hawk.png", sampleKo: "실버호크", titleKo: "실버호크", titleEn: "Silver Hawk", ms: 180000 },
    { id: "sharp-eyes", group: "bowman", icon: "sharp.png", sampleKo: "샤프아이즈", titleKo: "샤프아이즈", titleEn: "Sharp Eyes", ms: 300000 },
    { id: "concentration", group: "bowman", icon: "concentration.png", sampleKo: "집중", titleKo: "집중", titleEn: "Concentration", ms: 360000 },
    { id: "sniping", group: "bowman", icon: "sniping.png", sampleKo: "스나이핑", titleKo: "스나이핑", titleEn: "Sniping", ms: 10000 },
    ...
    { id: "spirit-javelin", group: "thief", icon: "spirit_javelin.png", sampleKo: "스피릿자벨린", titleKo: "스피릿자벨린", titleEn: "Spirit Javelin", ms: 120000 },
    { id: "meso-guard", group: "thief", icon: "meso_guard.png", sampleKo: "메소가드", titleKo: "메소가드", titleEn: "Meso Guard", ms: 180000 },
    { id: "smoke-shell", group: "thief", icon: "smoke_shell.png", sampleKo: "연막탄", titleKo: "연막탄", titleEn: "Smoke Shell", ms: 600000 },
    ...
    { id: "maple-warrior", group: "common", icon: "maple_warrior.png", sampleKo: "메이플용사", titleKo: "메이플용사", titleEn: "Maple Warrior", ms: 570000 },
    { id: "will", group: "common", icon: "will.png", sampleKo: "용사의의지", titleKo: "용사의의지", titleEn: "Hero's Will", ms: 600000 },
    { id: "time-leap", group: "common", icon: "time_leap.png", sampleKo: "타임리프", titleKo: "타임리프", titleEn: "Time Leap", ms: 1500000 },
    ...
    { id: "warrior-pill", group: "etc", icon: "warrior_pill.png", sampleKo: "전사의 알약", titleKo: "전사의 알약", titleEn: "Warrior Pill", ms: 600000 },
    { id: "magic-pill", group: "etc", icon: "magic_pill.png", sampleKo: "마법사의 알약", titleKo: "마법사의 알약", titleEn: "Magic Pill", ms: 600000 },
    { id: "sniper-pill", group: "etc", icon: "sniper_pill.png", sampleKo: "명사수의 알약", titleKo: "명사수의 알약", titleEn: "Sniper Pill", ms: 600000 },
    ...
    { id: "takoyaki", group: "etc", icon: "takoyaki.png", sampleKo: "타코야끼", titleKo: "타코야끼", titleEn: "Takoyaki", ms: 300000 },
